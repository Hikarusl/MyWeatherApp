...
export default function ErrorMessage({ message }) {
  const PoliteError = {
    'Ошибка при получении координат':
      'Не удалось определить координаты города. Попробуйте позже.',
    'Город не найден':
      'Такой город не найден. Проверьте правильность написания.',
    'Ошибка при получении прогноза погоды':
      'Не удалось загрузить прогноз. Попробуйте обновить страницу.',
    'Неизвестная ошибка':
